...
export const UNIVERSITY_LOGOS: Record<string, UniversityLogo> = {
  "서울대": { path: "/images/university/seoul.png", scale: 0.8 },
  "포항공대": { path: "/images/university/postech.png", scale: 0.8 },
  "연세대": { path: "/images/university/yonsei.jpg", scale: 1.5 },
  "고려대": { path: "/images/university/korea.gif", scale: 0.85 },
  "성균관대": { path: "/images/university/skku.jpg", scale: 1.35 },
  "한양대": { path: "/images/university/hanyang.svg", scale: 0.8 },
  "동국대": { path: "/images/university/dongguk.jpg", scale: 0.8 },
  "건국대": { path: "/images/university/konkuk.jpg", scale: 0.8 },
  "인하대": { path: "/images/university/inha.jpg", scale: 1.3 },
  "원광대": { path: "/images/university/wonkwang.jpg", scale: 0.8 },
  "전북대": { path: "/images/university/jeonbuk.png" },
};
